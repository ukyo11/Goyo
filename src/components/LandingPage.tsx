          ...
          <LinkWrapper to="/business/equipment">
            <BusinessCard whileHover={{ y: -10 }}>
              <IconWrapper>
                ...
                <img src={`/images/main/b1.png`} alt="장비 사업부 아이콘" />
              </IconWrapper>
              <h3>장비 사업부</h3>
              <p>반도체 & 디스플레이 설비 제작</p>
          ...
          <LinkWrapper to="/business/metal">
            <BusinessCard whileHover={{ y: -10 }}>
              <IconWrapper>
                ...
                <img src={`/images/main/b2.png`} alt="금속가공 사업부 아이콘" />
              </IconWrapper>
              <h3>금속가공 사업부</h3>
              <p>설비 부품 정밀 가공</p>
            </BusinessCard>
          ...
          <LinkWrapper to="/business/cleaning">
            <BusinessCard whileHover={{ y: -10 }}>
              <IconWrapper>
                ...
                <img src={`/images/main/b3.png`} alt="정밀세정 사업부 아이콘" />
              </IconWrapper>
              <h3>정밀세정 사업부</h3>
          ...
          <LinkWrapper to="/business/parts">
            <BusinessCard whileHover={{ y: -10 }}>
              <IconWrapper>
                ...
                <img src={`/images/main/b4.png`} alt="파트판매 사업부 아이콘" />
              </IconWrapper>
              <h3>파트판매 사업부</h3>
              <p>장비사 대상 구매대행</p>
